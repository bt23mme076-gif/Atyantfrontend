...
function SchedulePicker({ date, setDate, time, setTime, today }) {
 ...
 className="w-full rounded-2xl border bg-[#1A1823] p-4 text-sm outline-none transition focus:border-[#7567C9] focus:ring-2 focus:ring-[#7567C9]/20 border-[#322E40] bg-[#13121A] text-[#ECEAF3]"
 />
 </div>
 ...
 booked
 ?"cursor-not-allowed bg-black/[0.03] text-[#5F576F] border-[#322E40]/50 text-[#978FAB]"
 : isSelected
 ?"border-[#7567C9] bg-gradient-to-b from-[#7567C9] to-[#5a52a8] text-white shadow-lg shadow-[#7567C9]/30"
 :"bg-[#1A1823] text-[#ECEAF3] hover:border-[#7567C9]/60 border-[#322E40] bg-[#13121A] text-[#ECEAF3]"
 }`}
 >
 {booked ? (
 <>
 ...
 {slot.spotsLeft <= 2 && (
 <span className={`mt-1 rounded-full px-2 py-0.5 text-[9px] font-black ${isSelected ?"bg-white/20 text-white":"bg-red-100 text-red-600 bg-red-950/40 text-red-400"}`}>
 {slot.spotsLeft} left
 </span>
 )}
 </>
 ...
 <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-emerald-100 -900/40">
...
function TestimonialsSection({ active, setActive }) {
 ...
 active === i ?"h-2 w-6 bg-[#7567C9]":"h-2 w-2 bg-black/10 hover:bg-black/20 bg-[#221E33]"
 }`}
 />
 ))}
 </div>
...
function BookingSidebar({
 ...
 value.includes("Not") ?"text-gray-400":"text-[#ECEAF3]"
 }`}
 >
 {value}
 </span>
...
export default function BookingPage({ mentor }) {
	console.log("BookingPage mentor prop:", mentor);
 ...
 <span className="inline-flex items-center gap-1.5 rounded-full border border-[#7567C9]/30 bg-[#1A1823] px-3 py-1 text-xs font-bold text-[#8E80DB] bg-[#1A1823]">
 <FiShield size={12} />
 Verified Career Mentor
 </span>
 <span className="inline-flex items-center gap-1.5 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-bold text-emerald-700 dark:border-emerald-800 dark:text-emerald-400">
 <span className="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse"/>
 Online Now
 </span>
 <span className="inline-flex items-center gap-1.5 rounded-full border border-purple-200 bg-purple-50 px-3 py-1 text-xs font-bold text-purple-700 dark:border-purple-800 dark:text-purple-400">
 <HiSparkles size={12} />
 Top Mentor 2025
 </span>
 </div>
 ...
 {/* Footer */}
 <footer style={{ display: "none" }} className="mt-16 border-t py-8 border-[#322E40]">
 <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
 <div className="flex items-center gap-2.5">
 <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-[#7567C9] to-[#5a52a8] shadow-lg shadow-[#7567C9]/30">
 <FiZap size={14} className="text-white"/>
 </div>
 <span className="font-black text-[#ECEAF3]">MentorConnect</span>
 </div>
 <div className="flex flex-wrap justify-center gap-5 text-xs text-[#978FAB]">
 {["Privacy Policy","Terms of Service","Refund Policy","Contact Us"].map(
 (link) => (
 <a
 key={link}
 href="#"
 className="transition hover:text-[#7567C9]"
 >
 {link}
 </a>
 )
